...
function openEventQuickAdd(event) {
  ...
  const allSheets = [
    'txnFormSheet','assetFormSheet','debtFormSheet',
    'sipFormSheet','fuelFormSheet','confirmSheet','strategySheet',
    'amortizationSheet','addMenuSheet','eventCreateSheet'
  ];
  allSheets.forEach(id => document.getElementById(id)?.classList.add('translate-y-full'));
...
function openEventCreateSheet(event = null) {
  ...
  const allSheets = [
    'txnFormSheet','assetFormSheet','debtFormSheet',
    'sipFormSheet','fuelFormSheet','confirmSheet','strategySheet',
    'amortizationSheet','addMenuSheet','eventQuickAddSheet'
  ];
  allSheets.forEach(id => document.getElementById(id)?.classList.add('translate-y-full'));
...
function closeAllSheets() {
  ...
  const allSheets = [
    'txnFormSheet','assetFormSheet','debtFormSheet',
    'sipFormSheet','fuelFormSheet','confirmSheet','strategySheet',
    'amortizationSheet','addMenuSheet','eventCreateSheet','eventQuickAddSheet'
  ];
