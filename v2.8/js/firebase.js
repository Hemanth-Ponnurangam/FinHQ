...
export function initGlobalListeners() {
  const collections = ['transactions', 'assets', 'debts', 'budgets', 'goals', 'recurring', 'fuel', 'serviceLog', 'events'];

  // FIX: Use a Set instead of a counter — prevents double-counting if a collection
  // fires multiple snapshots before all collections have fired once.
...
export { collection, addDoc, doc, updateDoc, deleteDoc, serverTimestamp };
