...
export function initDashboard() {
  ...
  _unsubs.push(store.subscribe(state => {
    ...
    // Use the canonical getLiquidCash from store.js — the single source of truth
    // shared with analytics.js and export.js so all three surfaces agree.
    const liquidCash = state.getLiquidCash(state.transactions);
